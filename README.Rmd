...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/fxe1jxdykm5hvn1m?svg=true)](https://ci.appveyor.com/project/seabbs/stacktweetbot)
  ...
  [![Open the development environment](https://img.shields.io/badge/open- dev-lightgrey.svg)](https://labs.play-with-docker.com/?stack=https://raw.githubusercontent.com/seabbs/StackTweetBot/master/docker-compose.yml)
